class Solution {
    public int trap(int[] height) {
        ...
        */
        ...
        /*
        Instead of precomputed arrays, use two pointers from both ends 
        and track left max and right max variables. 
        At each step, process whichever side has the smaller max height 
        since trapped water is limited by the smaller boundary. 
        Compute trapped water at that position, 
        update the max, and move the pointer inward.
        */
