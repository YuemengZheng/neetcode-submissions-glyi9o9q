class Solution {
    public int maxProfit(int[] prices) {
        ...
        Initialize: I set hold to negative the first price, because if I buy on the first day, I spend that amount. 
        And I set notHold to 0, since I start with no stock and no profit.
        For each day, I update both states:
        hold becomes the max of the previous hold, or notHold - prices[i] 
            — that's the case where I buy today using the cash I had when not holding.
        notHold becomes the max of the previous notHold, or hold + prices[i] 
            — that's the case where I sell today the stock I was holding.
        Finally, I return notHold, the profit on the last day when I'm not holding any stock.
        */
