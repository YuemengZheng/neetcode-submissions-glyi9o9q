class Solution {
    public void sortColors(int[] nums) {
        ...
        "I use three pointers. p0 marks where the next 0 should go, p2 marks where the next 2 should go, 
        and cur scans through the array, placing each element into its correct region
