class Solution {
    public int ladderLength(String beginWord, String endWord, List<String> wordList) {
        ...
        Time complexity is m times n squared. m is the number of words, 
        and n is the average length of the word. The second n is for the StringBuilder operation

        Space complexity is O(m * n) for the set and queue
        */
