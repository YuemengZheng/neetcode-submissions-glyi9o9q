...
class Solution {
    ...
    public TreeNode buildTree(int[] preorder, int[] inorder) {
        /*
        Use DFS. 
        Preorder gives us the root value, 
        and inorder gives us the left and right partitions. 
        So we can build the root node and recursively build its left and right children.
        */
