...
class Solution {
    ...
    public TreeNode buildTree(int[] preorder, int[] inorder) {
        // cause preorder always gives us the middle element
        // inorder helps us divide the elements into left part and right part
        // so i will use dfs to first get the middle element, and then get the size of left and right subtrees
        // divide the preorder array into two parts, and recursively build the tree
