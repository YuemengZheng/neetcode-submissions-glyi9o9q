class NumMatrix {
    ...
    public NumMatrix(int[][] matrix) {
        ...
        Then each sumRegion query can be answered in O(1) using the inclusion-exclusion principle."
        ...
        I take the big rectangle from the origin to the bottom-right corner, 
        subtract the region above and the region to the left, and add back the top-left corner, since it was subtracted twice.
        */
        int m = matrix.length;
