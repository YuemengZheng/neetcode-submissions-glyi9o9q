class Solution {
    public boolean isValidSudoku(char[][] board) {
        ...
        in the same row, column, or subbox.

        To track this efficiently, we use three boolean matrix to record 
        ...
        */
        ...
        for(int i = 0; i < 9; i++){
            for(int j = 0; j < 9; j++){
                ...
                // convert the digit from character to an index from 0 to 8
                int num = c - '1'; //******** ERROR1 ********
                // compute which box the cell belongs to
                int box = (i / 3) * 3 + j / 3; //******** ERROR2 ********
